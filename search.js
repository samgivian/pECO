...
import { StyleSheet, Text, View, Modal, TouchableHighlight, Alert, StatusBar, Image, ImageBackground, Dimensions, KeyboardAvoidingView, Picker, TextInput } from "react-native";
    ...
    return (
      ...
      <KeyboardAvoidingView behavior="padding" style={styles.container}>
        <Content>
          ...
          <View style={{ width: '100%', height: 65, backgroundColor: '#32936f', top: 5, justifyContent: 'center' }}>
